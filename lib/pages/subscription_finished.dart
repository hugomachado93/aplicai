        ...
        body: Container(
            ...
            child: Column(
                ...
                children: [
                  ...
                  Text(demanda.name, style: TextStyle(fontSize: 20),),
                  SizedBox(
                    height: 10,
                  ),
                  ...
                  Row(
                    ...
                    children: demanda.categories.map((category) => Text("$category ")).toList(),
                  ),
                  SizedBox(
                    height: 180,
                  ),
                  Text(
                      "Você pode acompanhar o status da solicitação na aba de"),
